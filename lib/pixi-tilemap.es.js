...
/*!
 * pixi-tilemap - v2.0.6
 * Compiled Fri, 14 Aug 2020 02:41:40 UTC
 *
...
import { Texture, resources, Shader, Buffer, Geometry, BaseTexture, ObjectRenderer, Renderer } from '@pixi/core';
import { DRAW_MODES, ALPHA_MODES, WRAP_MODES } from '@pixi/constants';
...
var RectTileGeom = (function (_super) {
    ...
    function RectTileGeom() {
        ...
        var buf = _this.buf = new Buffer(new Float32Array(2), true, false);
...
var TileRenderer = (function (_super) {
    ...
    TileRenderer.prototype.initBounds = function () {
        ...
        for (var i = 0; i < maxTextures; i++) {
            ...
            var baseTex = new BaseTexture(resource);
...
export { CanvasTileRenderer, CompositeRectTileLayer, Constant, GraphicsLayer, MultiTextureResource, POINT_STRUCT_SIZE, RectTileGeom, RectTileLayer, RectTileShader, TileRenderer, TilemapShader, ZLayer, fillSamplers, generateFragmentSrc, generateSampleSrc, pixi_tilemap$1 as pixi_tilemap };
